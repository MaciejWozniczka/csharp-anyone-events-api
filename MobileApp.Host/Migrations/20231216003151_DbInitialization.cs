        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cities = table.Column<List<string>>(type: "text[]", nullable: true),
                    Countries = table.Column<int[]>(type: "integer[]", nullable: true),
                    Nationalities = table.Column<List<string>>(type: "text[]", nullable: true),
                    SexTypes = table.Column<int[]>(type: "integer[]", nullable: true),
                    Languages = table.Column<List<string>>(type: "text[]", nullable: true),
                    ExperienceLevels = table.Column<int[]>(type: "integer[]", nullable: true),
